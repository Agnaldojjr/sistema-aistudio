        ...
        <div className="fixed inset-0 z-[100] bg-black/95 backdrop-blur-sm flex flex-col">
          ...
          <div className="h-16 flex items-center justify-between px-4 md:px-6 bg-gradient-to-b from-black/80 to-transparent">
            <div className="text-white">
              <h3 className="font-bold text-sm md:text-base">{activePhoto.patient}</h3>
              <p className="text-[#C09553] text-xs font-mono">{activePhoto.label}</p>
            </div>
            <div className="flex items-center gap-3">
              ...
              <button onClick={() => downloadCanvasImage()} className="p-2 text-white/80 hover:text-white hover:bg-white/10 rounded-full transition-colors" title="Baixar Original/Editada">
                <Download className="w-5 h-5" />
              </button>
              <button onClick={() => setLightboxIndex(null)} className="p-2 text-white/80 hover:text-red-500 hover:bg-white/10 rounded-full transition-colors ml-2">
                <X className="w-6 h-6" />
              </button>
            </div>
          </div>
          ...
          <div className="h-16 md:h-20 bg-gradient-to-t from-black/90 to-transparent flex items-center justify-center gap-6 px-4">
            ...
            <div className="text-white/40 text-[10px] hidden md:flex items-center gap-1">
              <Move className="w-3 h-3" /> Arraste para mover • Role para zoom
            </div>
          </div>
        </div>
      )}
